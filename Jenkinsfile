  ...
  stages {
    stage('Build') {
      ...
      steps {
        ...
        nexusPolicyEvaluation advancedProperties: '', failBuildOnNetworkError: false, iqApplication: manualApplication('authNservice'), iqStage: 'build', jobCredentialsId: 'jenkins-nexus'
